				...
				<div class="registration-form">
					<form method="post">
						...
						<div class="form-group">
							<a href="game.php" class="btn btn-block create-account menubuttons" >Start</a>
						</div>
						
						<div class="form-group">
							<a href="rules.php" class="btn btn-block create-account menubuttons" >Rules</a>
						</div>
						
						
						<div class="form-group">
							<a href="logout.php" class="btn btn-block create-account menubuttons" >Exit</a>
						</div>
